...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                e.putBoolean(preference.getKey(), (Boolean)value);
                e.commit();*/
            } else {
        ...
        if(preference instanceof SwitchPreference){
            ...
            sBindPreferenceSummaryToValueListener.onPreferenceChange(preference,
                    PreferenceManager
                            ...
                            .getBoolean(pref.getKey(), pref.isChecked()));
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            SwitchPreference timelineEnabled = (SwitchPreference) findPreference("switch_timeline");
            bindPreferenceSummaryToValue(timelineEnabled);
        }
